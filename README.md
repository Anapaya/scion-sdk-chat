...
A chat application, written to show the SCION SDK. One server, three clients: a terminal client, an
Android app, and an iOS app. Every request between a client and the server is HTTP/3 over SCION.
